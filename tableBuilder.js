(function (e, t) {
  ...
  function t({ inRowClass: e, inHeaderHeight: t }) {
    let n = document.createElement(`tr`);
    return (e && (n.className = e), t && (n.style.height = t), n);
  }
  function n({ inElement: e, inOptions: t = {} }) {
    let n = e,
      r = t;
    (r.width && (n.style.width = r.width),
      r.align && (n.style.textAlign = r.align),
      r.vAlign && (n.style.verticalAlign = r.vAlign));
  }
  ...
  customElements.get(`ks-table-header-content`) ||
    customElements.define(`ks-table-header-content`, r);
  var i = { width: ``, align: ``, vAlign: `` };
  function a({
    inHeader: e = ``,
    inDataKey: t = ``,
    inOptions: r = i,
    ...
    return (
      (h.inputs = { header: c, dataKey: l, options: u, sortState: f }),
      m.appendChild(h),
      n({ inElement: m, inOptions: u }),
      m
    );
  }
  function o({
    inHeaderRowElement: e,
    inColumns: t,
    inClasses: n = {},
    inSortState: r = [],
    inOnSort: i = () => {},
    ...
    t.forEach((t) => {
      console.log(`appendHeaderCells -> columnData`, t);
      let o = a({
        inHeader: t.header,
        inDataKey: t.dataKey,
        inOptions: t.options || {},
  ...
  function s({ inHeaderRowElement: e, inCellClass: t }) {
  ...
  function c({
    ...
    let c = e,
      ...
      d = i,
      f = a,
      p = t({ inRowClass: l?.row, inHeaderHeight: u?.inHeaderHeight });
    return (
      o({
      ...
      s({ inHeaderRowElement: p, inCellClass: l?.cell }),
      p
    );
  }
  function l({
  ...
  function d(e, t) {
    let n = document.createElement(`button`),
      r = t.controlOptions || {};
    if (
      ((n.textContent = r.label || `Button`),
      (n.style.cssText = `padding: 0.375rem 0.75rem; font-size: 0.875rem; font-weight: 500; color: #ffffff; background-color: #3b82f6; border-radius: 0.375rem; border: none; cursor: pointer; transition: background-color 0.2s;`),
      (n.onmouseover = () => (n.style.backgroundColor = `#2563eb`)),
      (n.onmouseout = () => (n.style.backgroundColor = `#3b82f6`)),
      r.onClick)
    ) {
      let e;
      if (typeof r.onClick == `string`)
        try {
  ...
  function f(e, t) {
    let n = document.createElement(`button`);
    ((n.textContent = `View (${t.length})`),
      (n.style.cssText = `padding: 0.25rem 0.5rem; font-size: 0.75rem; font-weight: 500; color: #374151; background-color: #f3f4f6; border-radius: 0.375rem; border: 1px solid #d1d5db; cursor: pointer;`),
      (n.onmouseover = () => (n.style.backgroundColor = `#e5e7eb`)),
      (n.onmouseout = () => (n.style.backgroundColor = `#f3f4f6`)),
      e.appendChild(n));
  }
  function p(e, t) {
    (typeof t == `object` && t && (t = JSON.stringify(t)),
      (t ??= ``),
      (e.textContent = t));
  }
  ...
  customElements.get(`ks-table-cell-content`) ||
    customElements.define(`ks-table-cell-content`, m);
  function h({ inWrapperClass: e }) {
    let t = document.createElement(`tbody`);
    return (e && (t.className = e), t);
  }
  function g({ inElement: e, inOptions: t = {} }) {
    let n = e,
      r = t;
    (r.width && (n.style.width = r.width),
      r.align && (n.style.textAlign = r.align),
  ...
  function v({
    ...
    (s.cell && (c.className = s.cell),
      g({ inElement: c, inOptions: o }),
      typeof i == `object` &&
        i &&
        s.cellTruncate &&
        (c.className += (c.className ? ` ` : ``) + s.cellTruncate));
    let l = document.createElement(`ks-table-cell-content-common`);
    return (
      (l.inputs = { cellValue: i, rowData: a, options: o, classes: s }),
      c.appendChild(l),
      c
    );
  }
  var ee = ({ inClasses: e = {}, inBodyOptions: t = {} }) => {
      let n = e,
        r = t,
        i = document.createElement(`tr`);
      return (
        n.row && (i.className = n.row),
        r.inRowHeight && (i.style.height = r.inRowHeight),
        i
      );
    },
    y = ({ inClasses: e = {} }) => {
    ...
    b = ({
      ...
      let i = e,
        a = t,
        o = n,
        s = ee({ inClasses: o, inBodyOptions: r });
      a.forEach((e) => {
        let t = i[e.dataKey],
          n = v({
            inCellValue: t,
  ...
  function x({
    ...
    t.forEach((t) => {
      let a = b({ inItem: t, inColumns: n, inClasses: r, inBodyOptions: i });
      e.appendChild(a);
    });
  }
  function S({
  ...
  function ne({ inClasses: e = {} }) {
    ...
    return (
      t.emptyState && (n.className = t.emptyState),
      (n.textContent = `No data available`),
      n
    );
  }
  function re({ inClasses: e = {}, inCommonOptions: t = {} }) {
    ...
    return (
      n.table && (i.className = n.table),
      r.inTableWidth && (i.style.width = r.inTableWidth),
      r.inTableBorder &&
        (r.inTableBorder.includes(` `)
          ? (i.style.border = r.inTableBorder)
          : (i.style.borderWidth = r.inTableBorder)),
      i
    );
  }
  var ie = ({ inClasses: e = {} }) => {
      ...
      return (
        t.tr && (n.className = t.tr),
        (n.style.backgroundColor = `#f9fafb`),
        (n.style.borderTop = `2px solid #e5e7eb`),
        n
      );
    },
    w = {
    ...
    ae = ({ inData: e, inCol: t }) => {
      let n = e,
        ...
        i = ``;
      if (r.options) {
        if (r?.options?.table?.tfoot?.summary?.summaryLabel)
          i = r.options.table.tfoot.summary.summaryLabel;
        else if (r.options?.table?.tfoot?.summary?.summary) {
          let e = r.options.table.tfoot.summary.summary.toLowerCase();
          w[e] && (i = w[e]({ inData: n, inCol: r }));
        }
      }
      return i;
    };
  ...
  var se = ({ inClasses: e = {}, inCol: t }) => {
    ...
    ce = ({ inFootOptions: e = {}, inSummaryValue: t }) => {
      let n = e,
        r = t,
        i = document.createElement(`ks-table-cell-content-common`);
      return (
        n.inRowHeight && (i.style.minHeight = n.inRowHeight),
        (i.style.fontWeight = `bold`),
        (i.inputs = r === `` ? { cellValue: `` } : { cellValue: r }),
        i
      );
    },
    le = ({
      ...
      return (
        a.forEach((e) => {
          let t = se({ inClasses: o, inCol: e }),
            n = ae({ inData: i, inCol: e });
          l[e.dataKey] = n;
          let r = ce({ inFootOptions: s, inSummaryValue: n });
          (t.appendChild(r), c.appendChild(t));
        }),
        { builtTrElement: c, summaryValues: l }
      );
    },
    T = ({ inClasses: e = {} }) => {
      let t = e,
  ...
  function E({ inElement: e, inOptions: t = {} }) {
    let n = e,
      r = t;
    (r.width && (n.style.width = r.width),
      r.align && (n.style.textAlign = r.align),
  ...
  var D = ({ inClasses: e = {}, inCol: t }) => {
      let n = e,
        r = t,
        i = document.createElement(`td`);
      return (n.td && (i.className = n.td), r.options && E(i, r.options), i);
    },
    O = ({ inFootOptions: e = {}, inSummaryValue: t }) => {
      let n = e,
        r = t,
        i = document.createElement(`ks-table-cell-content-common`);
      return (
    ...
    k = ({
      ...
      return (
        a.forEach((e) => {
          let t = D({ inClasses: o, inCol: e }),
            n = ``,
            r = e?.options?.table?.tfoot?.summary?.balanceString;
          if (r)
            try {
          ...
          let i = O({ inFootOptions: s, inSummaryValue: n });
  ...
  var P = ({ inClasses: e = {}, inCol: t }) => {
      let n = e,
        r = t,
        i = document.createElement(`td`);
      return (n.td && (i.className = n.td), r.options && N(i, r.options), i);
    },
    F = ({ inFootOptions: e = {}, inSummaryValue: t }) => {
      let n = e,
        r = t,
        i = document.createElement(`ks-table-cell-content-common`);
      return (
        (i.style.fontWeight = `bold`),
        (i.inputs =
          r === `` ? { cellValue: `` } : { cellValue: r, options: n }),
        i
      );
    },
    I = ({ inData: e, inColumns: t, inClasses: n = {} }) => {
      let r = e,
        i = t,
        a = n,
        o = A({ inClasses: a });
      return (
        i.forEach((e) => {
          let t = P({ inClasses: a, inCol: e }),
            n = M({ inData: r, inCol: e }),
            i = F({
  ...
  function z({
    ...
    let _ = re({ inClasses: c, inCommonOptions: d }),
  ...
  var B = {
      ...
      topHeader: { show: !1, label: `Default Table`, placeholder: `Search...` },
      endPoints: {
        create: ``,
        update: ``,
        delete: ``,
  ...
  function U(e, t, n) {
    ...
    (n
      ? r === -1
        ? e.sortState.push({ dataKey: t, direction: `asc` })
        : (e.sortState[r].direction =
            e.sortState[r].direction === `asc` ? `desc` : `asc`)
      : r !== -1 && e.sortState.length === 1
        ? (e.sortState[0].direction =
            e.sortState[0].direction === `asc` ? `desc` : `asc`)
        : (e.sortState = [{ dataKey: t, direction: `asc` }]),
      W(e));
  }
  function W(e) {
    if (
      (e.sortState &&
        e.sortState.length > 0 &&
        e.dataStore.data.sort((t, n) => {
  ...
  function ue(e, t) {
    ...
    (n
      ? (e.dataStore.data = e.dataStore.originalData.filter((t) =>
          e.dataStore.columns.some((e) => {
            if (e.dataKey === `$serial`) return !1;
            let r = t[e.dataKey];
            return r != null && String(r).toLowerCase().includes(n);
          }),
        ))
      : (e.dataStore.data = [...e.dataStore.originalData]),
      W(e));
  }
  function de({
    inLabel: e = ``,
  ...
  function fe(e) {
    return e != null &&
      e !== `` &&
      (typeof e == `number` || /^\d+$/.test(String(e).trim()))
      ? `${e}px`
      : e;
  }
  var G = (e = {}) => {
  ...
  function pe({ inTopHeader: e }) {
    return e === H.topHeader
      ? {
          inShow: H.topHeader.show,
          inLabel: H.topHeader.label,
          inPlaceholder: H.topHeader.placeholder,
        }
      : {
          inShow: e.show === void 0 || e.show,
          inLabel: e.label === void 0 ? H.topHeader.label : e.label,
          inPlaceholder:
            e.placeholder === void 0 ? H.topHeader.placeholder : e.placeholder,
        };
  }
  function me({ inClasses: e, inTheme: t = `style1` }) {
    let n = e || {},
      r = V[t] || V.style1;
    return {
      ...r,
      ...
      head: { ...r.head, ...(n.head || {}) },
      body: { ...r.body, ...(n.body || {}) },
      topHeader: { ...r.topHeader, ...(n.topHeader || {}) },
    };
  }
  function he(e) {
    if (!e.htmlId) {
    ...
    (r && n.appendChild(r),
      (e.tableElement = e.buildTableElements()),
      n.appendChild(e.tableElement),
      t.appendChild(n));
  }
  var ge = (e, t) => {
          ...
          (n = [
            {
              header: `#`,
              dataKey: `$serial`,
              options: { width: `60px`, align: `center`, sortable: !0 },
            },
            ...n,
          ]),
        n
    ...
    _e = ({ inColumns: e, inShowSerialNo: t }) =>
      ge(e, t).map((e) => {
        let t = { ...e };
        return (
          t.options &&
            t.options.width &&
            (t.options = { ...t.options, width: fe(t.options.width) }),
          t
        );
      }),
    K = ({ inData: e, inShowSerialNo: t }) => {
      let n = Array.isArray(e) ? e : [e];
      return (t && (n = n.map((e, t) => ({ ...e, $serial: t + 1 }))), n);
    };
  ...
  var J = {
    ...
    create: async (e, t) => q(e, { method: `POST`, body: JSON.stringify(t) }),
    update: async (e, t) => q(e, { method: `PUT`, body: JSON.stringify(t) }),
  ...
  var Se = [
    ...
    Ce = (e, t) => {
      ...
      e.type = Se.includes(n) ? n : `text`;
    },
    we = (e, t) => {
      (t.placeholder && (e.placeholder = t.placeholder),
        t.value !== void 0 && (e.value = t.value),
        t.name && (e.name = t.name),
        t.id && (e.id = t.id));
    },
    Y = (e, t) => {
      (t.min !== void 0 && (e.min = t.min),
        t.max !== void 0 && (e.max = t.max),
        t.step !== void 0 && (e.step = t.step),
        t.maxLength !== void 0 && (e.maxLength = t.maxLength),
        t.pattern && (e.pattern = t.pattern));
    },
    Te = (e, t) => {
      (t.required && (e.required = !0),
        t.disabled && (e.disabled = !0),
        t.readOnly && (e.readOnly = !0),
        t.checked && (e.checked = !0),
        t.multiple && (e.multiple = !0));
    },
    Ee = (e) => {
      let t = document.createElement(`input`);
      return (Ce(t, e), we(t, e), Y(t, e), Te(t, e), t);
    },
    X = {
    ...
    Oe = (e) => {
      (e.addEventListener(`focus`, () => {
        ((e.style.borderColor = `#3b82f6`),
          (e.style.boxShadow = `0 0 0 3px rgba(59, 130, 246, 0.3)`));
      }),
        e.addEventListener(`blur`, () => {
          ((e.style.borderColor = `#d1d5db`),
            (e.style.boxShadow = `0 1px 2px 0 rgba(0, 0, 0, 0.05)`));
        }));
    },
    ke = (e, t = null) => {
      console.log(`startFunc`, e, t);
      let n = t || { controlType: `text`, placeholder: `Enter value...` },
        r = Ee(n);
      (De(r, n), Oe(r), e.appendChild(r));
    },
    Ae = class extends HTMLElement {
      ...
      render() {
        ...
        if (
          ((this.shadowRoot.innerHTML = ``), t.table?.tbody?.td, t?.showInput)
        ) {
          ke(this.shadowRoot, t);
          return;
        }
        if (Array.isArray(e)) {
          be(this.shadowRoot, e);
          return;
        }
        xe(this.shadowRoot, e);
      }
    };
  customElements.get(`ks-table-cell-content-common`) ||
    customElements.define(`ks-table-cell-content-common`, Ae);
  var Z = {
      showLogs: !1,
      log: function (...e) {
    ...
    Q = class {
      constructor({
        ...
        let c = e,
          ...
          d = r,
          f = s;
        (Z.log(`localData`, l), Z.log(`tableOptions-----------`, a));
        let p = G(a);
        (Z.log(`localTableOptionsMapped`, p),
          (this.tableOptions = p),
          (this.topHeader = pe({ inTopHeader: o })),
          (this.htmlId = c),
          (this.dataStore = ye({
            instance: this,
            localColumns: u,
          ...
          (this.classes = me({ inClasses: d, inTheme: i })),
          (this.sortState = []),
      ...
      buildTopHeaderElement() {
        return !this.topHeader || this.topHeader.inShow === !1
          ? null
          : de({
    ...
    $ = {
      inTableOptions: G(H.tableOptions),
      inTopHeader: {
        inShow: H.topHeader.show,
        inLabel: H.topHeader.label,
        inPlaceholder: H.topHeader.placeholder,
  ...
  ((window.ks = window.ks || {}),
    (window.ks.TableBuilder = Q),
    (window.ks.TableBuilder.DEFAULT_CLASSES = V),
    (window.ks.TableBuilder.DEFAULT_CONFIG = H),
    (window.ks.TableBuilder.DEFAULT_INTERNAL_OBJECT = $),
    (window.ks.TableBuilder.version = `v9.0`),
    (e.DEFAULT_CLASSES = V),
    (e.DEFAULT_CONFIG = H),
    (e.DEFAULT_INTERNAL_OBJECT = $),
    (e.TableBuilder = Q));
});
